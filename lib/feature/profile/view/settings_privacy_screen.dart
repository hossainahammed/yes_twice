                        ...
                        child: Column(
                          children: [
                            _buildMenuItem(
                              ...
                              onTap: () => Get.to(() => ResponsiveCenteredWrapper(child: EditProfileScreen()), preventDuplicates: false),
                            ),
                            _buildDivider(),
                            _buildMenuItem(
                              context,
                              ...
                              onTap: () => Get.to(() => ResponsiveCenteredWrapper(child: ChangePasswordScreen()), preventDuplicates: false),
                            ),
                          ],
                        ),
                      ),
                        ...
                        child: Column(
                          children: [
                            _buildMenuItem(
                              ...
                              onTap: () => Get.to(() => ResponsiveCenteredWrapper(child: PrivacyPolicyScreen()), preventDuplicates: false),
                            ),
                            _buildDivider(),
                            _buildMenuItem(
                              context,
                              ...
                              onTap: () => Get.to(() => ResponsiveCenteredWrapper(child: TermsConditionScreen()), preventDuplicates: false),
                            ),
                          ],
                        ),
                      ),
